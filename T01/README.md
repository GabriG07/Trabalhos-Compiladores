...
```
target/T01-1.0-SNAPSHOT-jar-with-dependencies.jar
```
...
```cmd
java -jar target\T01-1.0-SNAPSHOT-jar-with-dependencies.jar <arquivo-entrada> <arquivo-saida>
```
 
Exemplo:
 
```cmd
java -jar target\T01-1.0-SNAPSHOT-jar-with-dependencies.jar casos-de-teste\entrada.txt saida.txt
```
